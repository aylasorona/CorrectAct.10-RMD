...
# This code chunk is implemented to increase image quality and hide the code chunks to the reader. It also imports all the packages needed to create data visualizations.
