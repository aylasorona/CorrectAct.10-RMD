...
```
As we can see in this histogram, the frequency of stopping numbers follows a negative trend as the numbers increase. We can see that as the numbers grow on the x-axis, the frequency on the y-axis follows a decreasing trend. However, some numbers tend to go back and forth from increasing and decreasing on the histogram as we follow the x-axis. 
...
#This code chunk is implemented to create a summary statistic table of the price of diamonds by their cut.
...
#This code chunk is to include a screenshot of my file directory
knitr::include_graphics('Screenshot.png')
```
[Github Repository Link](https://github.com/aylasorona/CorrectAct.10-RMD/tree/main)
...
#| echo = TRUE,
#| eval = FALSE
```#Code chunk used to create code appendix at the bottom of the RMD file.
